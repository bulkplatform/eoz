    ...
    platformStyle(_platformStyle)
{
    ...
    // normal eozi address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying eozi address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &EoziAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
...
void SendCoinsEntry::clear()
{
    ...
    // update the display unit, to not use the default ("EOZ")
    updateDisplayUnit();
}
