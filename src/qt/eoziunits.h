...
#ifndef EOZI_QT_EOZIUNITS_H
#define EOZI_QT_EOZIUNITS_H
...
/** Eozi unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class EoziUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit EoziUnits(QObject *parent);

    /** Eozi units.
      @note Source: https://en.eozi.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        EOZ,
...
typedef EoziUnits::Unit EoziUnit;

#endif // EOZI_QT_EOZIUNITS_H
