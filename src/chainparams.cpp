...
{
    const char* pszTimestamp = "The Times 01/Marc/2009 A Sea Change to Crypto Hits America, Again";
...
public:
    CMainParams() {
		...
		consensus.vDeployments[Consensus::DEPLOYMENT_CSV].nTimeout = Consensus::BIP9Deployment::NO_TIMEOUT;// Deployment of SegWit (BIP141, BIP143, and BIP147)
        ...
        assert(genesis.hashMerkleRoot == uint256S("0x3dcdac2fb2fa17eabe03b2597a9656d6cf4c9e567b213d42c1d0a3b5e151b0e8"));
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.eozi.jonasschnelli.ch");
        vSeeds.emplace_back("seed.tbtc.petertodd.org");
        vSeeds.emplace_back("seed.testnet.eozi.sprovoost.nl");
